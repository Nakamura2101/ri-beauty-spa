      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex flex-col">
            <span className="text-xl font-serif text-spa-deep tracking-widest">Ri Beauty Spa</span>
            <span className="text-[10px] tracking-widest opacity-40 font-bold uppercase">Kawasaki, Japan</span>
          </div>
