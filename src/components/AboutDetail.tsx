      ...
      <div className="container mx-auto px-6">
        ...
        <div className="mb-24 flex flex-col items-center text-center">
          ...
          <div className="space-y-3">
            ...
            <p className="text-[12px] tracking-[0.6em] text-black font-bold uppercase ml-[0.6em]">ABOUT RI BEAUTY SPA</p>
          </div>
        ...
        <div className="max-w-5xl mx-auto">
          {/* Ảnh: giảm kích thước (~1/2 trên desktop), vẫn responsive */}
            <div className="relative mb-24 overflow-hidden rounded-sm shadow-2xl w-full max-w-[240px] sm:max-w-[280px] md:max-w-[320px] mx-auto">
            <img 
          ...
          <div className="max-w-4xl mx-auto space-y-12">
            <div className="contentTight text-black font-normal text-xl text-justify">
            ...
            <div className="bg-eucalyptus/30 p-12 md:p-16 rounded-sm border border-spa-green/5 space-y-8">
              <div className="space-y-2">
                <h2 className="text-2xl font-serif text-black italic tracking-wide">Akatsuki Tokyo 株式会社</h2>
                <p className="text-[11px] uppercase tracking-[0.4em] text-black font-bold">MANAGEMENT & OPERATION</p>
              </div>
