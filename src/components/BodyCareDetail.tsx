...
import { BODY_CARE_ARTICLES, SQUARE_BOOKING_LINK } from '../constants';
...
export const BodyCareDetail: React.FC<Props> = ({ onBack }) => {
  const mainServices = BODY_CARE_ARTICLES.filter(item => item.tagEn !== 'OPTION');
  const optionServices = BODY_CARE_ARTICLES.filter(item => item.tagEn === 'OPTION');
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-6xl mx-auto mb-32">
          <div className="mb-16 border-l-4 border-spa-green pl-6 py-2">
            <h2 className="text-2xl md:text-3xl font-serif text-spa-deep">ボディ ケアサービス</h2>
        ...
        <div className="max-w-6xl mx-auto bg-gray-50/50 p-8 md:p-20 rounded-sm border border-gray-100">
              ...
              <div key={article.id} className="flex flex-col space-y-4 text-center group">
                ...
                <div className="space-y-2">
                  <div className="space-y-1">
                    ...
                    <p className="text-[7px] md:text-[8px] tracking-[0.1em] text-spa-green/60 font-bold uppercase">{article.titleEn}</p>
                  </div>
